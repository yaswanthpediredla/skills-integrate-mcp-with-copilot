...
@app.get("/activities")
def get_activities(
    search: str = Query(None, description="Search text for activity name or description"),
    sort: str = Query(None, description="Sort by 'name' or 'schedule'"),
    category: str = Query(None, description="Filter by category (future use)")
):
